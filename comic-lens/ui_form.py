...
#if QT_CONFIG(tooltip)
        self.box_screenshot.setToolTip(QCoreApplication.translate("MainWindow", u"Draw a box to select a character or text", None))
#endif // QT_CONFIG(tooltip)
        self.box_screenshot.setText(QCoreApplication.translate("MainWindow", u" Box", None))
