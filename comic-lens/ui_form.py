...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.fit.setToolTip(QCoreApplication.translate("MainWindow", u"Fit to the area", None))
#endif // QT_CONFIG(tooltip)
        self.fit.setText("")
#if QT_CONFIG(tooltip)
        ...
        self.current_file_label.setText(QCoreApplication.translate("MainWindow", u"Open a book to start.", None))
